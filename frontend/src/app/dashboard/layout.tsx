...
import { IconHome, IconUsers, IconDocument, IconDatabase, IconChart, IconChevronLeft, IconChevronRight } from "@/components/icons";
...
const SIDEBAR_LINKS: { href: string; label: string; icon: React.ReactNode; permission?: string }[] = [
  ...
  { href: "/dashboard/dashboards", label: "Dashboards", icon: <IconChart /> },
